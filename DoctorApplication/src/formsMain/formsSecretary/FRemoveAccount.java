 ...
 * @author Zack
 */
public class FRemoveAccount extends javax.swing.JFrame {

    /**
     * Creates new form RemoveAccount
     */
    public FRemoveAccount() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Remove patient account");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRemoveAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
